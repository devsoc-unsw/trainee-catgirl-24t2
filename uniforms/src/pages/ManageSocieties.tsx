    ...
    {isDesktop && 
        ...
        <div className="flex flex-col h-[100%]">
                ...
                <div className=" overflow-auto hide-scrollbar flex flex-col items-center ">
                    <SocietyBanner imageUrl="https://media.discordapp.net/attachments/1274960540233502781/1284406338427945091/die.png?ex=66e6841e&is=66e5329e&hm=49ea1c77a8760cc3b9e95ca98ec34cd36a4903e5f0a6d8ce0dffbfd8f0cbb482&=&format=webp&quality=lossless&width=1100&height=400"></SocietyBanner>
                    <div className="flex items-center justify-between w-[80%]">
                        ...
                        <Link to={`${"/managesocieties/view"}`} className={buttonVariants({ variant: "default" }) + "text-foreground hover:text-black"} >
